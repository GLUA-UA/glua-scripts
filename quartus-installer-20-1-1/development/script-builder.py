#
# A Quartus Prime Lite Edition 20.1.1 script builder
# GLUA - Author: Miguel Vila
#

#
# This script generates a Quartus Prime Lite Edition 20.1.1 script
...
# a new one called "quartus-lite-20.1.1-ubuntu-22.04.sh".
#
...
def main():
    ...
    for file in files:
        ...
        new_script_name = "quartus-lite-20-1-1-" + file_name + ".sh"
